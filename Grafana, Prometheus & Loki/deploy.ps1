...
# ════════════════════════════════════════════════════════════
$S3_BUCKET              = "qa-chimdi-s3-777"      # e.g. qa-demo-s3-777
$AWS_REGION             = "eu-west-2"
$CLUSTER_NAME           = "my-cluster"
$MONITORING_NS          = "monitoring"
$QA_NS                  = "qa"
$GRAFANA_ADMIN_PASSWORD = "admin123"
$NODE_ROLE_NAME         = "eksctl-my-cluster-nodegroup-my-nod-NodeInstanceRole-FiKx1p2n79Bd" # eksctl-my-cluster-nodegroup-...-NodeInstanceRole-...
# ════════════════════════════════════════════════════════════
...
(Get-Content "05-loki-s3-iam-policy.json") -replace 'qa-chimdi-s3-777', $S3_BUCKET |
...
try {
    ...
    Log "LokiS3Policy exists - creating new version..."
...
(Get-Content "02-loki-values.yaml") `
    -replace 'qa-chimdi-s3-777', $S3_BUCKET `
    -replace 'eu-west-2', $AWS_REGION |
